...
// document.getElementsByClassName('productIgst')['0'].style.width = '400px'
  ...
  inIntFun(stringToMumber)
  {
    return parseFloat(stringToMumber)
  }
    ...
    for(let stock of this.data)
      {
        ...
        if (stock.remaining_quantity_to_purchase > 0) {
          stock.quantity=stock.remaining_quantity_to_purchase;
          console.log("stock.remaining_quantity_to_purchase",stock.remaining_quantity_to_purchase)
        }
  ...
  addStock()
  {
    ...
    // console.log(this.data);
     ...
     //  console.log(stock.supplier);
      ...
      if(typeof(stock.entry_date) == "undefined" ||stock.entry_date==''){

        Swal.fire('Something is Missing', 'Please check Entry Date', 'error');
        this.submited=0;
        return 0;
      ...
      if( stock.product_price=='undefined' || stock.product_price=='undefined' || stock.product_price==''|| typeof(stock.product_price) == "undefined" ){
        ...
        Swal.fire('Something is Missing', 'Please provide prodct price', 'error');
        this.submited=0;
        return 0;
        
      }

       if(stock.supplier==''|| typeof(stock.supplier) == "undefined"  || typeof(stock.purchaseInvoie) == "undefined" || typeof(stock.quantity) == "undefined" || stock.quantity=='' || stock.purchaseInvoie=='' || typeof(stock.entry_date) == "undefined" ||stock.entry_date=='' || stock.product_price =='')
        {
         this.overConsume=1;
        }
       // if (stock.remaining_quantity_to_purchase > 0) {
