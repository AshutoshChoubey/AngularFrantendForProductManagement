import { RequisitionlistnewComponent } from './Requisition/requisitionlistnew/requisitionlistnew.component';
...
import { IndentListNewComponent } from './Indent/indent-list-new/indent-list-new.component';
...
const routes: Routes = [
  ...
  {path: 'IndentListNew',component : IndentListNewComponent,canActivate : [AfterloginService] },
  ...
  {path: 'requisitionListNew',component : RequisitionlistnewComponent,canActivate : [AfterloginService] },
