...
@Component({
  selector: 'app-indent-list-new',
  templateUrl: './indent-list-new.component.html',
  styleUrls: ['./indent-list-new.component.css']
})
export class IndentListNewComponent implements OnInit {
