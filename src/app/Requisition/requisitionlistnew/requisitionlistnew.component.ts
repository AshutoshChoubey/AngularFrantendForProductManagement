...
@Component({
  selector: 'app-requisitionlistnew',
  templateUrl: './requisitionlistnew.component.html',
  styleUrls: ['./requisitionlistnew.component.css']
})
export class RequisitionlistnewComponent implements OnInit {
...
// });
  ...
  public exportButton()
  {
    ...
    $('#example').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            { extend: 'copyHtml5', footer: true ,title: 'Requisition List'},
            { extend: 'excelHtml5', footer: true ,title: 'Requisition List Report'},
            { extend: 'csvHtml5', footer: true,title: 'Requisition List Report' },
            { extend: 'pdfHtml5', footer: true ,title: 'Requisition List Report',orientation: 'landscape',pageSize:'A3'}
        ]
    } );
